...
const { validate, shopSchema } = require('../utils/validators');
...
router.post('/', authenticateToken, requireRole('admin'), validate(shopSchema), shopController.createShop);
router.put('/:id', authenticateToken, requireRole('admin'), validate(shopSchema), shopController.updateShop);
